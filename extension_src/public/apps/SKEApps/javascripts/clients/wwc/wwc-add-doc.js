...
var wwc_go = {
	getSecondary: function(id){
		gadget_helper.get(environment.remote+"/apps/wwc/doc-dropdown.json?primary="+id.toString(), {}, dropdown.createSecondaryDropdown);
	},
	getSubtopic: function(id){
		gadget_helper.get(environment.remote+"/apps/wwc/doc-dropdown.json?secondary="+id.toString(), {}, dropdown.createSubtopicDropdown);
	}
}
